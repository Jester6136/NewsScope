...
def format_sample(sample):
    ...
    sample['event_type_labels'] = random.randint(0, 7)
    return sample
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file_in",
                        ...
                        type=str,
                        help="")
    # python D:\NewsScope\modules\datasets\train_valid_split copy.py -file_in data/data_processed/squad_mrc2.jsonl
    ...
    train_dataset.save_to_disk('data1/train.dataset')
    valid_dataset.save_to_disk('data1/valid.dataset')
    test_dataset.save_to_disk('data1/test.dataset')
